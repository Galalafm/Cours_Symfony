...
use AppBundle\Entity\StudentType;
...
class StudentTypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $studentTypes = $em->getRepository('AppBundle:StudentType')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\StudentTypeType', $studentType);
    ...
    {
        $deleteForm = $this->createDeleteForm($studentType);
        $editForm = $this->createForm('AppBundle\Form\StudentTypeType', $studentType);
